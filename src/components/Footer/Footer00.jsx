...
export default function Footer00() {
  return (
    <footer className="relative w-full bg-gradient-to-tl from-[#F3F4F6] to-[#F3F4F6] z-30">
      <div className="mx-auto w-full container px-8 py-6">
        <div className="grid grid-cols-1 justify-between md:gap-6 gap-4 md:grid-cols-5 sm:grid-cols-2 pr-2">
          <div className="flex flex-col gap-3  col-span-1 sm:col-span-2 md:col-span-1">
            <h2 className="mb-3 !text-[#111827] font-semibold ">
              Do You Need Help ?
            </h2>
            <p className="py-1.5  text-[#4B5563] font-normal transition-colors hover:!text-gray-900">
            ...
            <div className="flex flex-row gap-3 justify-between">
              <FiPhoneCall size={30} />
              <span className="">
                <p className="text-[#4B5563] font-normal transition-colors hover:!text-gray-900">Monday-Friday: 08am-9pm</p>
                <h2 className="text-[#111827] text-[23px]">0 800 300-353</h2>
              </span>
            </div>
            <div className="flex flex-row gap-3 justify-between">
              <MdMailOutline size={30} />
              <span className="">
                <p className="text-[#4B5563] font-normal transition-colors hover:!text-gray-900">Need help with your order?</p>
                <h2 className="text-[#111827] text-[19px]">info@example.com</h2>
              </span>
            </div>
          </div>
            {aS.map(({ title, items }) => (
              <ul key={title+2045}>
                <div className="mb-3 !text-[#111827] font-semibold ">
                  {title}
                </div>
                {items.map((a) => (
                  <a key={a+130} to={`/${a[1]}`}>
                      <li >
                        <div
                          className="py-1.5  text-[#4B5563] font-normal transition-colors hover:!text-gray-900"
                        >
                          {a[0]}
                        </div>
                      </li>
            ...
            <a className="grid grid-cols-3 gap-3">
              <div className="flex flex-row gap-3 col-span-2 justify-between text-white bg-[#0a0f18] p-[6px] rounded-md">
                ...
                <span className="text-[.7rem] flex flex-col">
                  ...
                  <h2 className="#text-[#111827] font-bold">Google&nbsp;Play</h2>
                </span>
              </div>
            </a>
            <a className="grid grid-cols-3 gap-3">
              <div className="flex flex-row gap-3 col-span-2 justify-between text-white bg-[#0a0f18] p-[6px] rounded-md">
                ...
                <span className="text-[.7rem] flex flex-col">
                  ...
                  <h2 className="#text-[#111827] font-bold">App&nbsp;Store</h2>
                </span>
              </div>
            </a>
            <p className="py-1.5  text-[#4B5563] font-normal transition-colors hover:!text-gray-900">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <div className="mb-4 text-center font-normal flex text-[#4B5563] md:mb-0">
            &copy; {currentYear} <a to="/">reba-vid</a>.All
            Rights Reserved.
          </div>
