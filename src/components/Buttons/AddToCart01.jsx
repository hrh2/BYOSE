...
export default function AddToCart01() {
  return (
    <button className="inline-flex border-[#FFF] hover:scale-105 active:scale-110 text-[#FFF] border-[2px] bg-[#16A34A] hover:bg-[#4c9f57] hover:text-[#FFF]  font-bold rounded-xl w-auto">
